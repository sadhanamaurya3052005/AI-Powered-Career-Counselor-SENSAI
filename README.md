...
# AI-Powered-Career-Counselor-SENSAI
...
## 🌟 Key Features--
**AI Resume Builder**: Create ATS-friendly resumes & optimize content in real-time using Gemini AI.
**AI Mock Interviews**: Practice interviews tailored to your specific role and recieve detailed feedback for improvement.
**Real-time Industry Insights**: Monitor market trends,salary date and growth outlooks updated weekly.
**Intelligent Cover Letters**: Generate professionals ,tailored cover letters based on specific job descriptions.
**Automated Market Tracking**: Keeps all data synced and relevant using Inngest and Cron jobs.
...
2.**Install Dependencies**:
    ...
    npm install
    ```
3.**Setup Environment Variables**:Create a .env file and add your credentials.
    ```env
